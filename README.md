...
![alt text](create-vite-package-name.png)
...
![alt text](localhost-link.png)
![alt text](vite-project-interface.png)
...
Antes:
![alt text](index-html-antes.png)

Depois:
![alt text](index-html-depois.png)
...
![alt text](criacao-pasta-components.png)
...
A estruturação no sue VS Code fiacará da seguinte forma:
![alt text](estruturacao-componentes-pasta-components.png)
...
![alt text](exemplo-estruturaca-componente.png)
...
##### `index.css`
![alt text](estilizacao-index-css.png)
...
##### `AddTaskInput.css`
![alt text](add-task-input-css.png)
...
##### `App.css`
![alt text](arquivo-app-css.png)


### Passo 04: Execução do projeto
Temos o nosso projeto, agora é só executar usando o comando `npm run dev` e abrir o link do localhost que aparecer no terminal. Pronto, agora é só usar o site para gerencias suas tarefas.
...
![alt text](resultado-alcancado.png)
